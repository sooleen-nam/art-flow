...
const ARTWORKS = [
  {
    ...
    emotionImages: {
      ...
      energy:     { url: 'bird_활기.png',    palette: ['#e82020','#f57820','#f5d020','#c84020','#f5e878'] },
    },
    layers: [
...
const EMOTIONS = [
  {
    ...
    feel: '밝고 신나는 느낌',
    color: '#FFD93D',
    gradient: 'linear-gradient(135deg,#FFD93D,#FFADAD)',
  ...
  },
  {
    ...
    feel: '차분하고 안정된 느낌',
    color: '#74B9FF',
    gradient: 'linear-gradient(135deg,#74B9FF,#b8e0d2)',
  ...
  },
  {
    id: 'energy',
    locked: true,
    tutorMsg: 'AI 마음튜터가 에너지 넘치는 마음으로 그릴 수 있도록 실시간으로 도와줄게요',
    name: '활기', icon: '',
    desc: '빠르고 리듬감 있는 선으로<br>에너지 넘치는 느낌을 담아요',
    lineHint: '빠르고 리듬감 있는 선',
    patternHint: '튀는 점, 확산 패턴',
    feel: '에너지 넘치고 역동적인 느낌',
    color: '#E17055',
    gradient: 'linear-gradient(135deg,#fd9644,#d63031)',
    transform: (c) => shiftColor(c, { h: -20, s: +38, l: -5 }),
    defaultBrush: 9,
    coaching: [
      '너무 천천히 그리고 있어! 좀 더 빠르고 힘차게 그려볼까?!',
      '빨강과 주황을 강조해서 강렬한 에너지를 담아봐!',
      '점을 여기저기 튀기듯 그려보는 것도 좋아!',
    ],
    resultMain: '에너지 넘치고 역동적인 마음이 가득 담겼어요!',
    anim: 'burst',
  },
];
